...
const char* history_plugin_advice_text = _("\033[32mPlease ensure that the \033[2mpose::history_plugin\033[22m is enabled on the RPC node you are connecting to and that an account involved in this transaction was configured in the \033[2mfilter-on\033[22m setting.\033[0m\n");
...
You can refer to contracts/poselib/transaction.hpp for reference)=====";
...
const char* error_advice_tx_duplicate =  "You can try embedding pose nonce action inside your transaction to ensure uniqueness.";
...
const char* error_advice_missing_chain_api_plugin_exception =  "Ensure that you have \033[2mpose::chain_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_missing_wallet_api_plugin_exception =  "Ensure that you have \033[2mpose::wallet_api_plugin\033[0m\033[32m added to your node's configuration!\n"\
                                    "Otherwise specify your wallet location with \033[2m--wallet-url\033[0m\033[32m argument!";
const char* error_advice_missing_history_api_plugin_exception =  "Ensure that you have \033[2mpose::history_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_missing_net_api_plugin_exception =  "Ensure that you have \033[2mpose::net_api_plugin\033[0m\033[32m added to your node's configuration!";
...
bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   ...
   // refer to libraries/chain/include/pose/chain/exceptions.hpp
